       ...
       // private static TimeSpan _elapsedTime;
        ...
        public NtfsUsnJournal(DriveInfo driveInfo)
        {
            ...
            if (0 == string.Compare(_driveInfo.DriveFormat, "ntfs", true))
            {
                ...
                UsnJournalReturnCode usnRtnCode = GetRootHandle(out IntPtr rootHandle);
            ...
            CreateUsnJournal(ulong maxSize, ulong allocationDelta)
        {
            ...
            if (bNtfsVolume)
            {
                if (_usnJournalRootHandle.ToInt64() != Win32Api.INVALID_HANDLE_VALUE)
                {
                    ...
                    Win32Api.RtlZeroMemory(cujdBuffer, sizeCujd);
            ...
            DeleteUsnJournal(Win32Api.USN_JOURNAL_DATA journalState)
        {
            ...
            if (bNtfsVolume)
            {
                if (_usnJournalRootHandle.ToInt64() != Win32Api.INVALID_HANDLE_VALUE)
                {
                    ...
                    Win32Api.RtlZeroMemory(dujdBuffer, sizeDujd);
            ...
            if (bNtfsVolume)
            {
                if (_usnJournalRootHandle.ToInt64() != Win32Api.INVALID_HANDLE_VALUE)
                {
                    ...
                    if (usnRtnCode == UsnJournalReturnCode.USN_JOURNAL_SUCCESS)
                    {
                        ...
                        Win32Api.RtlZeroMemory(rujdBuffer, sizeRujd);
            ...
            GetVolumeSerialNumber(DriveInfo driveInfo, out uint volumeSerialNumber)
        {
            ...
            {
                _ = new Win32Api.BY_HANDLE_FILE_INFORMATION();
                bool bRtn = Win32Api.GetFileInformationByHandle(hRoot, out Win32Api.BY_HANDLE_FILE_INFORMATION fi);
